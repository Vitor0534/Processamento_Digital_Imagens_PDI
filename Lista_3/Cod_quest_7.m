%7.	Altere o Ângulo para 90 e 196, exiba o resultado e explique a diferença 
%entre diferentes saídas.
...
imshow(imgFiltred(:,:,:));
title('img filtrada matlab angulo=90');
figure();
...
imgFiltred= imfilter(img1,filtro,'replicate');
imshow(imgFiltred(:,:,:));
title('img filtrada matlab, angulo=196');
figure();
