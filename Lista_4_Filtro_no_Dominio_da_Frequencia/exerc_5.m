% 5.	Utilize a imagem resultante na questão 4 e refaça-a questão com ela,
% explique se teve alguma diferença, e mostre a magnitude antes de aplicar
% a máscara de novo. Volte a imagem para o domínio do tempo e mostre o 
% resultado. 
...
% não se usa rgb2gray(img1) porque a imagem já esta em escala de cinza
imgGray = img1;  
