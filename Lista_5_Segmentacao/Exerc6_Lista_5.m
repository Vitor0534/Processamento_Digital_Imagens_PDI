...
for i=5:n
    ...
    %% configurando os parâmetros da função regiongrowing()
      ...
      %utiliada para extrair o Roi, da imagem por meio da aplicação dela na
      %imagem.
      x=size(img1,1)/2; 
      y=size(img1,2)/2;
...
% Aplica o processo de cresacimento de região iniciando o agrupamento de
